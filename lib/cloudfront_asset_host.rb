  ...
  class << self
    ...
    def enable!
      if enabled
        ...
        ActionView::Helpers::AssetTagHelper::AssetPaths.send(:alias_method_chain, :rewrite_asset_path, :cloudfront)
        ActionView::Helpers::AssetTagHelper::AssetPaths.send(:alias_method_chain, :rails_asset_id, :cloudfront)
      end
    end
